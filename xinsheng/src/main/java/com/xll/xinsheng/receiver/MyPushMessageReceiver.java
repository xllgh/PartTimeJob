package com.xll.xinsheng.receiver;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
    ...
    public void onBind(Context context, int errorCode, String appid,
        ...
        if (errorCode == 0) {
           ...
           Cache generalCache = new Cache(context, Cache.GENERAL_INFO);
           String strUsername = generalCache.getString(Cache.KEY_USERNAME);

            map.put("channelId",channelId);
            map.put("loginId", strUsername);
            HttpUtils.post(HttpUtils.CHANNELID_UPDATE, map, null);
            Log.d(TAG, "绑定成功");
        }
